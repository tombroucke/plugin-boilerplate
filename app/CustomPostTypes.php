...
class CustomPostTypes
{
    ...
    private function postTypeLabels($singular_name, $plural_name)
    {
        return [
            ...
            'add_new_item' => sprintf(__('Add New %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'edit_item' => sprintf(__('Edit %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'new_item' => sprintf(__('New %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'view_item' => sprintf(__('View %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: plural post name */
            'view_items' => sprintf(__('View %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular post name */
            'search_items' => sprintf(__('Search %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: plural post name to lower */
            'not_found' => sprintf(__('No %s found.', 'plugin-boilerplate'), strtolower($plural_name)),
            /* translators: %s: plural post name to lower */
            ...
            /* translators: %s: singular post name */
            'parent_item_colon' => sprintf(__('Parent %s:', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'all_items' => sprintf(__('All %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular post name */
            'archives' => sprintf(__('%s Archives', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'attributes' => sprintf(__('%s Attributes', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name to lower */
            'insert_into_item' => sprintf(__('Insert into %s', 'plugin-boilerplate'), strtolower($singular_name)),
            /* translators: %s: singular post name to lower */
            ...
            /* translators: %s: plural post name to lower */
            'filter_items_list' => sprintf(__('Filter %s list', 'plugin-boilerplate'), strtolower($plural_name)),
            /* translators: %s: singular post name */
            'items_list_navigation' => sprintf(__('%s list navigation', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular post name */
            'items_list' => sprintf(__('%s list', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular post name */
            'item_published' => sprintf(__('%s published.', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            ...
            /* translators: %s: singular post name */
            'item_reverted_to_draft' => sprintf(__('%s reverted to draft.', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'item_scheduled' => sprintf(__('%s scheduled.', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular post name */
            'item_updated' => sprintf(__('%s updated.', 'plugin-boilerplate'), $singular_name),
        ];
    }
    ...
    private function taxonomyLabels($singular_name, $plural_name)
    {
        return [
            ...
            'search_items' => sprintf(__('Search %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: plural taxonomy name */
            'popular_items' => sprintf(__('Popular %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: plural taxonomy name */
            'all_items' => sprintf(__('All %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular taxonomy name */
            'parent_item' => sprintf(__('Parent %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular taxonomy name */
            'parent_item_colon' => sprintf(__('Parent %s:', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular taxonomy name */
            'edit_item' => sprintf(__('Edit %s', 'plugin-boilerplate'), $singular_name),
            ...
            'view_item' => sprintf(__('View %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular taxonomy name */
            'update_item' => sprintf(__('Update %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular taxonomy name */
            'add_new_item' => sprintf(__('Add New %s', 'plugin-boilerplate'), $singular_name),
            /* translators: %s: singular taxonomy name */
            'new_item_name' => sprintf(__('New %s Name', 'plugin-boilerplate'), $singular_name),
            ...
            'not_found' => sprintf(__('No %s found', 'plugin-boilerplate'), strtolower($plural_name)),
            /* translators: %s: plural taxonomy name to lower */
            'no_terms'  => sprintf(__('No %s', 'plugin-boilerplate'), strtolower($plural_name)),
            /* translators: %s: plural taxonomy name */
            'items_list_navigation' => sprintf(__('%s list navigation', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: plural taxonomy name */
            'items_list' => sprintf(__('%s list', 'plugin-boilerplate'), $plural_name),
            'most_used' => 'Most Used',
            /* translators: %s: plural taxonomy name */
            'back_to_items' => sprintf(__('&larr; Back to %s', 'plugin-boilerplate'), $plural_name),
            /* translators: %s: singular taxonomy name to lower */
            'no_item'   => sprintf(__('No %s', 'plugin-boilerplate'), strtolower($singular_name)),
            /* translators: %s: singular taxonomy name to lower */
            'filter_by' => sprintf(__('Filter by %s', 'plugin-boilerplate'), strtolower($singular_name)),
        ];
    }
}
